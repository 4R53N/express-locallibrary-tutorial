...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    async.waterfall([
       ...
       function(results, callback){
        ...
        res.render('bookinstance_delete', {title: 'Delet Book Instance', book_instance: results});
        callback(null);
       }
    ], function (err){
      if(err){return next(err)};
...
exports.bookinstance_delete_post = function(req, res) {
  BookInstance.findByIdAndRemove(req.body.bookinstanceid,function delete_bookinstance(err){
    if(err){ return next(err);}
    res.redirect('/catalog/bookinstances');
  });
};
